...
public class InGameUI : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        UpdateScoreUI();
        ContinueButton.onClick.AddListener(CrazyGamesAds.Instance.ShowRewardedAd);
    ...
    private IEnumerator lostPanelDisplayTime()
    {
        AfterLostScoreUI();
        SaveHighScore();
        HighScores.Instance.SetLeaderBoard(PlayerPrefs.GetString("PlayerName", "Player"), highScore);
