...
public class CoinSpawn : MonoBehaviour
{
    ...
    [SerializeField] private int coinThreshold ;
    [SerializeField] private int thresholdAdd ;
    [SerializeField] private float coinIntervalDecreaseRate ;
    ...
    private void Update()
    {
        if( InGameUI.Instance.score > coinThreshold)
        {
            coinSpawnInterval -= coinIntervalDecreaseRate;
            coinThreshold += thresholdAdd ; 
        }
