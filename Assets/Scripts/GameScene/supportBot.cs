...
public class SupportBot : MonoBehaviour
{
    ...
    [SerializeField] private Vector3 rangOffset;
    ...
    private void AttackIfEnemyInRange()
    {
        ...
        {
            Collider2D[] enemiesInRange = Physics2D.OverlapBoxAll(transform.position + rangOffset, new Vector2(attackRangeX, attackRangeY), 0f, enemy);
    ...
    private void OnDrawGizmosSelected()
    {
        ...
        Gizmos.DrawWireCube(transform.position + rangOffset , new Vector3(attackRangeX, attackRangeY, 1));
    }
}
